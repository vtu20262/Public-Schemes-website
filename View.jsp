...
<body>
            ...
            <div class="tm-nav-container tm-bg-color-8">
                <nav class="tm-nav" id="tm-nav">
                    <ul>
                        ...
                        <li class="tm-nav-item">
                            <a href="View.jsp" class="tm-nav-link">
    ...
    <table align="center" border="1" style="width: 50% !important; margin-left: 3px;line-height: 1.7;background: aliceblue;border-radius: 12px;text-align: left;color: black;text-transform: capitalize;">
	            ...
	            <%
                        ...
                        PreparedStatement query=con.prepareStatement("select * from addoptical ");
	            ...
	            %>
	            			<tr>
	            				<td><%=rs.getString("id") %></td>       
                                                ...
                                                <td><u><a href="view1.jsp?id=<%=rs.getString("id")%>&&name=<%=rs.getString("gname")%>"><%=rs.getString("brand") %></a></u></td>
	            				<td><%=rs.getString("gname") %></td>
	            				<td><%=rs.getString("shape") %></td>
                                                <td><%=rs.getString("size") %></td>
                                                <td><%=rs.getInt("type") %></td>
                                                <td><%=rs.getString("color") %></td>
                                                <td><%=rs.getInt("image") %></td>
                                        </tr>		
	            <%	
	            	}	
	            %>
