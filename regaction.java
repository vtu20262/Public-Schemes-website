...
public class regaction extends HttpServlet {
  ...
  List<String> ms = new ArrayList<String>();
		...
		try 
		{
		    ...
		    PreparedStatement query=con.prepareStatement("insert into reg(user,pass,gender,mail,mobile,address,profile)values ('"+m.get(0)+"','"+m.get(1)+"','"+m.get(2)+"','"+m.get(3)+"','"+m.get(4)+"','"+m.get(5)+"','"+ms.get(0)+"')");
